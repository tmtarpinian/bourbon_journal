...
bourbon5 = Bourbon.create(name: "Evan Williams Bottled-in-Bond", proof: 100)
bourbon6 = Bourbon.create(name: "Old Forester", distillery: "Old Forester Bourbon Distilling Co.", proof: 100)